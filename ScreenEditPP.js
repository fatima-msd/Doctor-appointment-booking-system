...
export default class ScreenEditPP extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  selectPhotoTapped() {
    ...
    ImagePicker.showImagePicker(options, response => {
      ...
      if (response.didCancel) {
        ...
        //var timestamp = new Date().valueOf() + '.jpg';
        // console.log('______________');
         console.log(response);
        this.setState({
          Photo: response.data,
          // Photo: this.state.imagesCopy.concat(response.uri),
          // imagesAddress: this.state.imagesAddress.concat(timestamp),
            ...
            />
              ...
              <View
                ...
                <Picker
                  ...
                  onValueChange={txt => this.setState({GenderID: txt})}>
